...
describe('LocalStorageAuthCache', () => {
  ...
  beforeEach(() => {
    cache = new LocalStorageAuthCache();
  });
...
describe('AuthCacheFactory', () => {
  it('createMemoryCache returns MemoryAuthCache', () => {
    expect(AuthCacheFactory.createMemoryCache()).toBeInstanceOf(
      MemoryAuthCache
    );
  });

  it('createLocalStorageCache returns LocalStorageAuthCache', () => {
    expect(AuthCacheFactory.createLocalStorageCache()).toBeInstanceOf(
      LocalStorageAuthCache
    );
  });

  it('createPersistentCache returns LocalStorageAuthCache', () => {
    expect(AuthCacheFactory.createPersistentCache()).toBeInstanceOf(
      LocalStorageAuthCache
    );
  });
});
