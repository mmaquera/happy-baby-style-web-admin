...
describe('convertToRelativePath', () => {
  ...
  it('returns relative path unchanged', () => {
    expect(convertToRelativePath('/images/product.jpg')).toBe('/images/product.jpg');
  });
  ...
  it('extracts pathname from absolute URL', () => {
    expect(convertToRelativePath('https://cdn.example.com/images/product.jpg'))
      .toBe('/images/product.jpg');
  });

  it('extracts pathname from http URL', () => {
    expect(convertToRelativePath('http://localhost:3000/uploads/img.png'))
...
describe('convertImageUrlsToRelativePaths', () => {
  it('converts array of absolute URLs to relative paths', () => {
    ...
    expect(convertImageUrlsToRelativePaths(urls)).toEqual(['/img1.jpg', '/img2.jpg']);
  });
...
describe('isValidBackendImageUrl', () => {
  it('returns true for https URL', () => {
    expect(isValidBackendImageUrl('https://cdn.example.com/img.jpg')).toBe(true);
  });
