...
const getProviderBorderColor = (provider: AuthProvider): string => {
  switch (provider) {
    case AuthProvider.google: return '#4285f4';
    case AuthProvider.facebook: return '#1877f2';
    case AuthProvider.apple: return '#000000';
    case AuthProvider.email: return 'var(--color-brand-purple)';
      ...
      {accounts.map(account => {
        ...
        return (
          <Card
            ...
            style={{ borderLeftColor: getProviderBorderColor(account.provider) }}
          >
            {/* Header */}
