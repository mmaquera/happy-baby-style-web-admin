    ...
    >
      ...
      <nav className='flex-1 overflow-y-auto py-4'>
        <div className='mb-6'>
          ...
          <CollapsibleNavItem to='/' end isCollapsed={isCollapsed} icon={<HomeIcon size={20} />}>
            Dashboard
          </CollapsibleNavItem>
        </div>
        ...
        <div className='mb-6'>
          ...
          <CollapsibleNavItem to='/products' isCollapsed={isCollapsed} icon={<PackageIcon size={20} />}>
            Productos
          </CollapsibleNavItem>
          <CollapsibleNavItem to='/categories' isCollapsed={isCollapsed} icon={<FolderIcon size={20} />}>
            Categorías
          </CollapsibleNavItem>
          <CollapsibleNavItem to='/orders' isCollapsed={isCollapsed} icon={<ShoppingCartIcon size={20} />}>
            Pedidos
          </CollapsibleNavItem>
          <CollapsibleNavItem to='/users' isCollapsed={isCollapsed} icon={<UsersIcon size={20} />}>
            Usuarios
          </CollapsibleNavItem>
          <CollapsibleNavItem to='/images' isCollapsed={isCollapsed} icon={<ImageIcon size={20} />}>
            Imágenes
          </CollapsibleNavItem>
        </div>
        ...
        <div className='mb-6'>
          ...
          <CollapsibleNavItem to='/analytics' isCollapsed={isCollapsed} icon={<BarChart3Icon size={20} />}>
            Estadísticas
          </CollapsibleNavItem>
        </div>
        ...
        <div className='mb-6'>
          ...
          <CollapsibleNavItem to='/settings' isCollapsed={isCollapsed} icon={<SettingsIcon size={20} />}>
            Ajustes
          </CollapsibleNavItem>
        </div>
      </nav>
      ...
      >
        ...
        >
          © 2025 <span className='font-medium text-brand-purple'>Happy Baby Style</span>
          <br />
