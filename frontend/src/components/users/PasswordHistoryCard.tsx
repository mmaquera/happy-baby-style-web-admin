...
const ActionIcon = styled.div<{ type: 'reset' | 'temporary' | 'admin_set' | 'user_change' }>`
  width: 32px;
  height: 32px;
  ...
  background: ${props => {
    switch (props.type) {
      case 'reset': return theme.colors.warning.light;
      case 'temporary': return theme.colors.info.light;
      case 'admin_set': return theme.colors.error.light;
      case 'user_change': return theme.colors.success.light;
      default: return theme.colors.primaryPurple}10;
    }
  }};
  color: ${props => {
    switch (props.type) {
      case 'reset': return theme.colors.warning.main;
      case 'temporary': return theme.colors.info.main;
      case 'admin_set': return theme.colors.error.main;
      case 'user_change': return theme.colors.success.main;
...
const StatusBadge = styled.div<{ status: 'completed' | 'pending' | 'failed' }>`
  ...
  background: ${props => {
    switch (props.status) {
      case 'completed': return theme.colors.success.light;
      case 'pending': return theme.colors.warning.light;
      case 'failed': return theme.colors.error.light;
